...
//   console.log("test");
  getUserReadLocation(position.coords.latitude, position.coords.longitude);
...
function getUserReadLocation(lat, long) {
//   console.log("getUserReadLocation");
...
function buildLocationName(myCity) {
  //   console.log(myCity);  
    let myCityElement = document.getElementById("location");
    myCityElement.innerText = myCity;
  }
